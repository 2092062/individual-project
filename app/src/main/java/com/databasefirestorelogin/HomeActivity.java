...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewMsg.setText(getIntent().getStringExtra("welcomemsg"));
        View.OnClickListener listener = new View.OnClickListener() {
            public void onClick(View view) {
                Fragment fragment = null;
                if (view == findViewById(R.id.profile)) {
                    fragment = new DatabaseFIrestoreProfile();
                }
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id) {
                    case R.id.dashboard:
                        ...
                        intent.putExtra("welcomemsg",getIntent().getStringExtra("welcomemsg"));
               ...
               /*     case R.id.myprofile:
                    ...
                    case R.id.logout:
                        Intent logout = new Intent(getApplicationContext(), LaunchingActivity.class);
    ...
    private void diolougebox() {
        ...
        builder1.setMessage("Do you want to close the App");  //message we want to show the end user
