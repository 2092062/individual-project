...
public class DatabaseFIrestoreRegistration extends Fragment {
    ...
    public DatabaseFIrestoreRegistration() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.window_register, container, false);
        ...
        fAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    user.put("db_name", name);
                    user.put("db_email", email);
                    user.put("db_password", password);
                    user.put("db_city", city);
                    user.put("db_birthdate", dob);
                    user.put("db_gender", gender);
